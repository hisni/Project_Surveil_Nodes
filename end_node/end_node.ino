...
//  Serial.print("DHT ");
//  Serial.print("temperature read : "+String(t));
//  Serial.println("  humidity read : "+String(h));
//
//  Serial.print("BMP ");
//  Serial.print("temperature read : "+String(temp));
//  Serial.print("  Pressure read : "+String(p));
//  Serial.println("  Altitude read : "+String(a));
//  
//  Serial.print("Gyro ");
